...
import os
import argparse
from ddf_surveys import generate_dd_surveys, generate_daily_dd_surveys
...
if __name__ == "__main__":
    ...
    ddf_daily = generate_daily_dd_surveys(nside=nside, nexp=nexp, detailers=details)
    ddfs.extend(ddf_daily)
